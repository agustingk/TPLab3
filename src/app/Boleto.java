...
public class Boleto {
	...
	public int indiceTren;////Es el indice que tiene el tren en la listaDeTrenes de la Terminal. Es para diferenciar trenes entre si (ej., un mismo modelo de tren con el mismo destino).
